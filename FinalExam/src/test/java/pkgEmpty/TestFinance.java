...
public class TestFinance {
	...
	public void TestPV() {
		...
		double Payments = retirement.MonthlySavings();
		double PresentValue = retirement.TotalAmountToSave();
		...
		assertEquals(1454485.55,Math.abs(PresentValue),0.01);
		assertEquals(554.13,Math.abs(Payments),0.01);
